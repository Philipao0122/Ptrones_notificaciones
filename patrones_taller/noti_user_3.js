  ...
  async function cargarNotificaciones() {
    const url = 'http://localhost:5000/notificaciones/usuario3.html'; // Cambia el destinatario según sea necesario
    try {
...
function mostrarNotificaciones(notificaciones) {
    ...
    notificaciones.forEach(notificacion => {
        ...
        li.textContent = `${notificacion.fecha}: ${notificacion.Asunto} - ${notificacion.mensaje}`;
